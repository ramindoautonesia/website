+++
title = 'HardWork End Cap'
subtitle = 'Cable Festoon Systems for Power and Control'
categories = ['HardWork', 'End Cap', 'Cable Festoon Systems for Power and Control']
coverImage = 'hardwork/ec.png'
+++
...
{{< csv-to-table path="specs/hardwork-ec.csv" >}}
